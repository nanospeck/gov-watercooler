...
<body>
	<div class="navbar navbar-default navbar-fixed-top">
		<div class="container">
            ...
            <li><a href="http://builtwithbootstrap.com/" target="_blank">Big data, bite size.</a></li>
			...
			<div class="row">
				<div class="col-lg-8 col-md-7 col-sm-6">
					...
					<div class="lead">
						...
						<a class="btn btn-success" href='cardprev'>Previous
							Card</a> <a class="btn btn-success" href='/carddetails/${cardDTO.id}'>Card
							Details</a> <a class="btn btn-success" href='/cardnext/${cardDTO.id}'>Next
							Card</a>
			</div>
